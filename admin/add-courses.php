			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Agregar Cursos </h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Nombre Corto del Curso</label>
												<div class="col-sm-8">
...
<div class="form-group">
									<label class="col-sm-2 control-label">Nombre Completo del Curso</label>
									<div class="col-sm-8">
									<input type="text" class="form-control" name="cnf" value="" >
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Agregar Curso">
												</div>
											</div>
